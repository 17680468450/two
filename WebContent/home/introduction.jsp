		...
		<div class="scoll">
			...
			<div class="flexslider">
				<ul class="slides">
					...
					<li><img src="<%=basePath %>/images/02.jpg" /></li>
					<li><img src="<%=basePath %>/images/03.jpg" /></li>
				</ul>
			</div>
			</section>
		</div>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="<%=basePath %>/${imgs.p_url1 }"><img src="<%=basePath %>/${imgs.p_url1 }"
							alt="细节展示放大镜特效" rel="<%=basePath %>/${imgs.p_url1 }" class="jqzoom" /></a>
					</div>
					<ul class="tb-thumb" id="thumblist">
						<li class="tb-selected">
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=basePath %>/${imgs.p_url1 }"
									mid="<%=basePath %>/${imgs.p_url1 }" big="<%=basePath %>/${imgs.p_url1 }"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=basePath %>/${imgs.p_url2 }"
									mid="<%=basePath %>/${imgs.p_url2 }" big="<%=basePath %>/${imgs.p_url2 }"></a>
							</div>
						</li>
						<li>
							<div class="tb-pic tb-s40">
								<a href="#"><img src="<%=basePath %>/${imgs.p_url3 }"
									mid="<%=basePath %>/${imgs.p_url3 }" big="<%=basePath %>/${imgs.p_url3 }"></a>
							</div>
						</li>
					</ul>
				</div>
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						<li class="price iteminfo_price">
							<dt>单价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${shop.s_price }</b>
							</dd>
						</li>
						<!--
									...
									<form class="theme-signin" name="loginform" action=""
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name="" type="button" value="-" /> 
														...
														<c:if test="${shop.s_repertory > 0 }">
														<span id="Stock" class="tb-hidden">库存<span class="stock">${shop.s_repertory }</span>件</span>
														</c:if>
														<c:if test="${shop.s_repertory == 0 }">
														<span id="Stock" class="tb-hidden">库存<span class="stock">${shop.s_repertory }</span>件,以售空</span>
														</c:if>
												</dd>
											...
											<script type="text/javascript">
											   $(function () {
												   $("#add").click(function() {
													 	var text = Number($("#text_box").val());
													 	var repertory = Number("${shop.s_repertory }");
													 	if (text == repertory) {
															$(this).attr("disabled","");
														}else{
               ...
               <script type="text/javascript">
                   $("#LikBuy").click(function() {
					   ...
					   if ("${users }"=="") {
						...
						if(confirm("请问是否购买")){
							location.href="CheckoutServlet?type=out&&s_id=${shop.s_id }&&number="+number;
						}
					}
                   ...
                   $("#LikBasket").click(function() {
					   ...
					   if ("${users }"=="") {
						alert("请先登录");
						 ...
						 $.post("ShopcartServlet",{"s_id":"${shop.s_id }","number":number,"type":"add"},function(data){
	                		   alert(data);
	                	   })
					}
				...
				<div class="mc">
					<ul>
                      ...
                      <c:forEach var="item" items="${arr }">
						<li class="first">
							<div class="p-img">
								<a href="#"> <img class="" src="<%=basePath %>/${item.s_url}">
								</a>
							</div>
							<div class="p-name">
						...
						<!--  
							...
							<div class="details">
								...
								<div class="twlistNews">
									<img src="<%=basePath %>/${imgs.p_url1 }" /> 
									<img src="<%=basePath %>/${imgs.p_url2 }" /> 
									<img src="<%=basePath %>/${imgs.p_url3 }" /> 
									<!-- <img src="<%=basePath %>/images/tw2.jpg" />
									<img src="<%=basePath %>/images/tw3.jpg" /> <img src="<%=basePath %>/images/tw4.jpg" />
									<img src="<%=basePath %>/images/tw5.jpg" /> <img src="<%=basePath %>/images/tw6.jpg" />
							...
							<ul class="am-comments-list am-comments-list-flip">
								<li class="am-comment">
									<!-- 评论容器 --> <a href=""> <img class="am-comment-avatar"
										src="<%=basePath %>/images/hwbn40x40.jpg" /> <!-- 评论者头像 -->
								</a>
