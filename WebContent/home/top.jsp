			...
			<div class="am-container header">
					...
					<div class="topMessage">
						<div class="menu-hd">
						   ...
						   <c:if test="${empty users }">
							...
							<a href="<%=basePath %>/home/register.jsp" target="_top">注册</a>
						   </c:if>
						</div>
					</div>
				</ul>
				<ul class="message-r">
					...
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a href="#" id="index" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
					</div>
					...
					<div class="topMessage favorite">
						<div class="menu-hd"><a href="#" id="favorite" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a>
					</div>
				</ul>
				</div>
				<<script type="text/javascript">
				 $("#index").click(function () {
					 if ("${users }"=="") {
							...
							location.href = "<%=basePath %>/person/index.jsp";
						}
				});
