...
<body>
					...
					<div class="wrap-list">
						<div class="m-user">
							...
							<div class="m-userproperty">
								...
								<p class="m-coupon">
									<a href="coupon.jsp"> <em class="m-num">2</em> <span
										class="m-title">优惠券</span>
									</a>
								</p>
								<p class="m-wallet">
									<a href="wallet.jsp"> <em class="m-num">0.00</em> <span
										class="m-title">账户余额</span>
									</a>
								</p>
								<p class="m-bill">
									<a href="pointnew.jsp"> <em class="m-num">10</em> <span
							...
							<div class="wallet">
								...
								<p class="m-big squareS">
									<a href="#"> <i><img src="<%=basePath %>/images/shopping.png" /></i> <span
										class="m-title">能购物</span>
									</a>
								</p>
								<p class="m-big squareA">
									<a href="#"> <i><img src="<%=basePath %>/images/safe.png" /></i> <span
										class="m-title">够安全</span>
									</a>
								</p>
								<p class="m-big squareL">
									<a href="#"> <i><img src="<%=basePath %>/images/profit.png" /></i> <span
						...
						<div class="m-order">
							...
							<ul>
								...
								<li><a href="order.jsp"><i><img
											src="<%=basePath %>/images/send.png" /></i><span>待发货<em class="m-num">1</em></span></a></li>
								<li><a href="order.jsp"><i><img
							...
							<div class="orderContentBox">
								<div class="orderContent">
									<div class="orderContentpic">
										<div class="imgBox">
											<a href="orderinfo.jsp"><img src="<%=basePath %>/images/youzi.jpg"></a>
										</div>
									</div>
							...
							<div class="orderContentBox">
								<div class="orderContent">
									<div class="orderContentpic">
										<div class="imgBox">
											<a href="orderinfo.jsp"><img src="<%=basePath %>/images/heart.jpg"></a>
										</div>
									</div>
									<div class="detailContent">
						...
						<div class="user-squaredIcon">
							...
							<ul>
								...
								<a href="<%=basePath %>/home/home2.jsp">
									<li class="am-u-sm-4"><i
						...
						<div class="twoTab">
							<div class="twoTabModel Coupon">
								<h5 class="squareTitle">
									<a href="#"><span class="splitBorder"></span>优惠券<i
							...
							<div class="twoTabModel credit">
								...
								<div class="Box">
									...
									<div class="am-slider am-slider-default am-slider-carousel"
										...
										<ul class="am-slides">
											<li><a href="#"><img src="<%=basePath %>/images/333.jpg" /></a></li>
											<li><a href="#"><img src="<%=basePath %>/images/222.jpg" /></a></li>
											<li><a href="#"><img src="<%=basePath %>/images/111.jpg" /></a></li>
											<li><a href="#"><img src="<%=basePath %>/images/333.jpg" /></a></li>
											<li><a href="#"><img src="<%=basePath %>/images/222.jpg" /></a></li>
											<li><a href="#"><img src="<%=basePath %>/images/111.jpg" /></a></li>
										</ul>
					...
					<div class="new-goods">
						...
						<div class="new-goods-info">
							<a class="shop-info" href="#" target="_blank">
								<div>
									<img src="<%=basePath %>/images/666.jpg" alt="">
							...
							<div class="am-slider am-slider-default am-slider-carousel"
								...
								<ul class="am-slides">
									<li><a><img class="am-thumbnail"
											src="<%=basePath %>/images/EZA27501.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="<%=basePath %>/images/BxJk6.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="<%=basePath %>/images/Hxcag60.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="<%=basePath %>/images/youzi.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
									<li><a><img class="am-thumbnail"
											src="<%=basePath %>/images/EZA27501.jpg" /></a> <strong class="price">¥32.9</strong>
									</li>
		...
		<ul>
			...
			<li class="person">
				...
				<ul>
					...
					<li><a href="<%=basePath %>/QueryAddressServlet">地址管理</a></li>
			...
			<li class="person">
				...
				<ul>
					...
					<li><a href="<%=basePath %>/FootServlet">足迹</a></li>
				</ul>
			</li>
	...
	<!--引导 -->
	<div class="navCir">
		<li><a href="<%=basePath %>/home/home2.jsp"><i class="am-icon-home "></i>首页</a></li>
		<li><a href="<%=basePath %>/home/sort.jsp"><i class="am-icon-list"></i>分类</a></li>
		<li><a href="<%=basePath %>/home/shopcart.jsp"><i
